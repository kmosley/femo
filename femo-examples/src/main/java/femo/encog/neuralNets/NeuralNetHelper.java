...
public class NeuralNetHelper {
    public static <DataType> ArrayList<DoubleFeature<DataType>> normalizeFeatures(List<DoubleFeature<DataType>> features, FemoActivationFunction activationFunction, Iterator<DataType> dataIterator) throws Exception {
        ...
        ArrayList<DoubleFeature<DataType>> normalizedFeatures = new ArrayList<DoubleFeature<DataType>>(features.size());
        for(int i=0; i<features.size(); i++){
